...
namespace App\Components\LogDB\Listeners;

use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Log;
use App\Components\LogDB\Models\LogDB;
use Jenssegers\Agent\Agent;
use Illuminate\Support\Facades\Auth;
use Carbon\Carbon;

class LogDBEventListener
{
    private $agent;
    ...
    {
        $events->listen('event.emergency', 'App\Components\LogDB\Listeners\LogDBEventListener@onEmergency', 10);
        $events->listen('event.alert', 'App\Components\LogDB\Listeners\LogDBEventListener@onAlert', 10);
        $events->listen('event.critical', 'App\Components\LogDB\Listeners\LogDBEventListener@onCritical', 10);
        $events->listen('event.error', 'App\Components\LogDB\Listeners\LogDBEventListener@onError', 10);
        $events->listen('event.warning', 'App\Components\LogDB\Listeners\LogDBEventListener@onWarning', 10);
        $events->listen('event.notice', 'App\Components\LogDB\Listeners\LogDBEventListener@onNotice', 10);
        $events->listen('event.info', 'App\Components\LogDB\Listeners\LogDBEventListener@onInfo', 10);
        $events->listen('event.debug', 'App\Components\LogDB\Listeners\LogDBEventListener@onDebug', 10);
    }
